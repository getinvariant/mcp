...
const CRISIS_RESOURCES = [
  ...
  },
  {
    ...
    description:
      "Free, confidential treatment referral and information service for substance abuse and mental health.",
  ...
  },
  {
    ...
    available: "24/7",
    description:
      "Connects veterans and their families with qualified responders.",
  ...
  },
  {
    ...
    description:
      "Comprehensive mental health information from the National Institute of Mental Health.",
    ...
    availableActions: [
      {
        ...
        description:
          "List all crisis resources, optionally filtered by type (hotline, text, resource)",
        parameters: {
          type: {
            type: "string",
            description: "Filter by type: hotline, text, or resource",
            required: false,
          },
        },
      },
      {
        ...
        description:
          "Search resources by keyword (e.g., anxiety, veterans, substance abuse)",
        parameters: {
          keyword: {
            type: "string",
